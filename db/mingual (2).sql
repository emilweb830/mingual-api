...
--
-- Host: localhost:3306
-- Generation Time: Sep 22, 2016 at 10:21 AM
...
CREATE TABLE IF NOT EXISTS `photos` (
  `id_photo` int(255) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `reports` (
  `id_report` int(255) unsigned NOT NULL AUTO_INCREMENT,
  `id_user` int(255) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `sch_city` varchar(128) CHARACTER SET utf8 NOT NULL,
  `sch_gender` varchar(2) NOT NULL,
  `sch_age_low` int(8) NOT NULL,
  `sch_age_high` int(8) NOT NULL,
  `sch_type` varchar(2) NOT NULL,
